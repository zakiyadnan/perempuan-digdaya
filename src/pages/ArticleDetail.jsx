    ...
    <div className="p-4 md:p-10 max-w-4xl mx-auto">
      ...
      <div className="flex gap-2 mb-6 flex-wrap">
        {(article.keywords || []).map((kw) => (
          <button
            key={kw}
            onClick={() => navigate(`/articles?keyword=${encodeURIComponent(kw)}`)}
            ...
            {para
              ...
              .map((part, i) =>
                ["Perempuan Digdaya", "Komunitas PeDe", "Digital & Berdaya"].includes(part) ? (
                  <span key={i} className="font-bold text-pink-600">{part}</span>
                ) : (
      ...
      {/* Related Posts */}
      <h2 className="text-2xl font-bold mt-10 mb-6 text-gray-800">Artikel Lainnya</h2>
